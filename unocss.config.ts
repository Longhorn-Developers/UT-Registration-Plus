...
export default defineConfig({
    ...
    shortcuts: {
        ...
        linkanimate:
            'relative cursor-pointer transition duration-100 ease-out after:(absolute left-1 right-1 h-2px scale-x-95 bg-ut-orange opacity-0 transition duration-250 ease-out-expo content-empty bottom-0.5 -translate-y-0.5) active:scale-95 hover:text-ut-orange focus-visible:text-ut-orange hover:after:(opacity-100) !hover:after:translate-y-0 !hover:after:scale-x-100',
    },
    theme: {
        easing: {
