 ...
 */
export default function useRelativeTime(timestamp: number | null | undefined): string | null {
    const [text, setText] = useState(() => (timestamp ? formatRelative(timestamp) : null));
