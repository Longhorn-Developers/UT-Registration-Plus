...
if (!support) {
    throw new Error(
        "UT Registration Plus does not support this page, even though it should...",
    );
}
...
if (
    support === SiteSupport.COURSE_CATALOG_DETAILS ||
    support === SiteSupport.COURSE_CATALOG_LIST
) {
...
onContextInvalidated(() => {
    ...
    render(
        <ContextInvalidated className="bg-ut-burntorange text-white font-mono" />,
        div,
    );
});
