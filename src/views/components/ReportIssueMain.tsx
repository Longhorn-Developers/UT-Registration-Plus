...
export default function ReportIssueMain(): JSX.Element {
        ...
        return (
            <div className="w-80 bg-white p-6">
                ...
                <p className="mb-6 text-gray-600">
                    Your feedback is music to our ears. Thanks for helping us
                    improve!
                </p>
                <button
    ...
    return (
        <div className="w-80 bg-white p-6">
            <h2 className="mb-4 text-2xl text-ut-burntorange font-bold">
                Longhorn Feedback
            </h2>
            <p className="mb-4 text-sm text-ut-black">
            ...
            <form onSubmit={submitFeedback}>
                <div className="mb-4">
                    <label
                        htmlFor="email"
                        className="mb-1 block text-sm text-ut-black font-medium"
                    >
