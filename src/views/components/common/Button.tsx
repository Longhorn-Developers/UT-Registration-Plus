    ...
    return (
            ...
            className={clsx(
                "btn",
                {
                    ...
                    "bg-opacity-0 border-current hover:enabled:bg-opacity-8 border stroke-width-[1px]":
                        variant === "outline",
                    "bg-opacity-0 border-none hover:enabled:bg-opacity-8":
                        variant === "minimal",
                    "h-10 gap-spacing-3 px-spacing-5":
                        size === "regular" && !isIconOnly,
                    "h-10 w-10 p-spacing-2": size === "regular" && isIconOnly,
                    "h-[35px] gap-spacing-3 px-spacing-3":
                        size === "small" && !isIconOnly,
                    "h-[35px] w-[35px] p-spacing-2":
                        size === "small" && isIconOnly,
        ...
        >
            {Icon && (
                <Icon
                    {...iconProps}
                    className={clsx("h-6 w-6", iconProps?.className)}
                />
            )}
            {!isIconOnly && (
                <Text
