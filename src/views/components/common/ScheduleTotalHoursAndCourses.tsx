    ...
    return (
        <div className="w-full flex flex-col items-start">
            <div className="max-w-full overflow-hidden">
                <Text
                    className="block w-full truncate text-ut-burntorange"
                    variant="h1"
                    as="span"
                >
                    {scheduleName}
            ...
            <Text
                variant="h3"
                as="div"
                className="flex flex-row items-center gap-2.5 text-theme-black"
            >
                <Text
                    variant="h4"
                    as="span"
                    className="inline text-theme-black"
                >
                    {totalHours}&nbsp;
                    <Text
                        variant="h3"
                        as="span"
                        className="inline text-theme-black font-all-small-caps!"
                    >
