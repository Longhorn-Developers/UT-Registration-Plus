...
export default function HeadingAndActions({
    ...
    const courseAdded = activeSchedule.courses.some(
        (ourCourse) => ourCourse.uniqueId === uniqueId,
    );
    ...
    const getInstructorFullName = (instructor: Instructor) =>
        instructor.toString({ format: "first_last" });
        ...
        if (!courseAdded) {
            ...
            if (
                ...
                activeSchedule.courses.every(
                    (otherCourse) =>
                        otherCourse.semester.code !== currentSemesterCode,
                )
            ) {
                ...
                showDialog({
                    ...
                    description: (
                        <>
                            ...
                            . Mixing semesters in one schedule may cause
                            confusion.
                        </>
                    ),
        ...
        <div className="w-full px-2 pb-3 pt-5 text-ut-black">
            <div className="flex flex-col">
                <div className="flex items-center gap-1">
                    ...
                    <Text
                        variant="h1"
                        className="flex-1 whitespace-nowrap text-theme-black"
                    >
                    ...
                    <button
                        className="bg-transparent p-0 text-ut-black btn"
                        onClick={onClose}
                    >
                        <X className="h-6 w-6" />
                    </button>
