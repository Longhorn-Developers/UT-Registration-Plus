...
const DEVELOPER_RECRUIT_FROM_DEPARTMENTS = new Set([
    "C S",
    "ECE",
    "MIS",
    "CSE",
...
const DesignerRecruitmentBanner = () => (
    <div className={styles.container}>
        <Text className="text-white">
            Design for thousands of UT students through Longhorn Developers on
            real-world projects like UT Reg. Plus.—build your portfolio and
            collaborate in Figma. Apply{" "}
...
export default function RecruitmentBanner(): JSX.Element | null {
    ...
    return createPortal(
        recruitmentType === "DEVELOPER" ? (
            <DeveloperRecruitmentBanner />
        ) : (
            <DesignerRecruitmentBanner />
        ),
        container,
    );
}
