...
export default function CalendarHeader({ sidebarOpen, onSidebarToggle }: CalendarHeaderProps): JSX.Element {
    ...
    return (
        <div className='sticky left-0 right-0 min-h-[91px] flex items-center gap-5 overflow-x-auto overflow-y-hidden pt-spacing-5 pb-spacing-2 pl-spacing-7'>
            {!sidebarOpen && (
                <Button
                    variant='minimal'
                    color='theme-black'
                        ...
                        <Menu>
                            ...
                            <MenuItems
                                ...
                                className={clsx([
                                    styleResetClass,
                                    'mt-spacing-3',
                                    'w-[175px] cursor-pointer origin-top-right rounded bg-white p-1 text-black shadow-lg transition border border-ut-offwhite focus:outline-none',
