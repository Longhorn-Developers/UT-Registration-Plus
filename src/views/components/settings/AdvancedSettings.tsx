            ...
            <div className={PREVIEW_SECTION_DIV_CLASSNAME}>
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Adds a red strikethrough to courses that have
                            conflicting times.
                        </p>
                    </div>
                    <SwitchButton
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Loads all courses in the Course Schedule site by
                            scrolling, instead of using next/prev page buttons.
                        </p>
                    </div>
                    <SwitchButton
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Allow bypassing the 10-schedule limit. Intended for
                            advisors or staff who need to create many schedules
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Always opens the calendar view in a new tab when
                            navigating to the calendar page. May prevent issues
                            where the calendar refuses to open.
                        </p>
                    </div>
                    <SwitchButton
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Show a refresh button in the calendar to re-scrape
                            course data from UT&apos;s site.
                        </p>
                    </div>
                    <SwitchButton
                ...
                <div className="flex items-center justify-between">
                    <div className="max-w-xs">
                        ...
                        <p className="text-sm text-gray-600">
                            Show waitlisted, cancelled, and closed status on
                            courses.
                        </p>
                    </div>
                    <SwitchButton
            ...
            {DISPLAY_PREVIEWS && (
                <Preview>
                    <Text
                        variant="h2-course"
                        className={clsx(
                            "text-center text-theme-red font-normal",
                            {
