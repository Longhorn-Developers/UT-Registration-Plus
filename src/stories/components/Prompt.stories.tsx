...
const PromptDialogWithButton = ({ children, ...args }: PromptDialogProps) => {
    ...
    const childrenWithHandleClose: React.ReactElement[] = (children ?? []).map(
        (child) => {
...
export const AreYouSure: StoryObj<PromptDialogProps> = {
    ...
    args: {
        ...
        content: (
            <Text variant="p">
                Deleting Main Schedule is permanent and will remove all added
...
export const YouHave10ActiveSchedules: StoryObj<PromptDialogProps> = {
    ...
    args: {
        ...
        content: (
            <Text variant="p">
                To encourage organization, please consider removing some unused
...
export const WelcomeToUTRPV2: StoryObj<PromptDialogProps> = {
    ...
    args: {
        ...
        content: (
            <Text variant="p">
                You may have already began planning your Summer or Fall
                schedule. To migrate your courses into v2.0 please select
