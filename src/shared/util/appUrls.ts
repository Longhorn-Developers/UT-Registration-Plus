 ...
 */
export const UT_DINING_APP_STORE_URL = new URL(
    "https://apps.apple.com/us/app/ut-dining/id6743042002",
).toString();
 ...
 */
export const UT_DINING_PROMO_IMAGE_URL = new URL(
    "https://cdn.longhorns.dev/ut-dining-advert1.png",
).toString();
